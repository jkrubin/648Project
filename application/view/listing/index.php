...
<div class="add-listing">
    <div>
        <form action="<?php echo URL; ?>listing/addListing" method="POST"><br><br>
            ...
            <input type="text" name="zipCode" placeholder="Zip Code" /><br><br><br>
            ...
            <input type="text" name="baths" id="baths" placeholder="Number of Bathrooms" /><br><br><br>
            <textarea cols="126" rows="3" name="description" placeholder="Description"></textarea><br><br><br>
            <input type="text" name="sqFt" placeholder="Square Feet" />
            <input type="text" name="petDeposit" placeholder="Pet Deposit" />
            <input type="text" name="keyDeposit" placeholder="Key Deposit" /><br><br><br>
            Start date:
            <input type="date" name="startDate" placeholder="Available From (Date)" />
            End date:
            <input type="date" name="endDate" placeholder="Available To (Date)" /><br><br><br>
            Add images:<br><br>
            ...
            <input type="checkbox" name="furnished"/> <label>Furnished</label><br><br><br>
